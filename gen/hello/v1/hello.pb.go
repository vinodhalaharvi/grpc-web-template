...
func (x *SayHelloResponse) GetCount() int32 {
	if x != nil {
		return x.Count
	}
	return 0
...
const file_hello_v1_hello_proto_rawDesc = "" +
	...
	"\x05count\x18\x02 \x01(\x05R\x05count2\x9e\x01\n" +
	"\x0eGreeterService\x12A\n" +
	"\bSayHello\x12\x19.hello.v1.SayHelloRequest\x1a\x1a.hello.v1.SayHelloResponse\x12I\n" +
	"\x0eSayHelloStream\x12\x19.hello.v1.SayHelloRequest\x1a\x1a.hello.v1.SayHelloResponse0\x01B\x90\x01\n" +
	"\fcom.hello.v1B\n" +
	"HelloProtoP\x01Z3github.com/myorg/grpc-web-demo/gen/hello/v1;hellov1\xa2\x02\x03HXX\xaa\x02\bHello.V1\xca\x02\bHello\\V1\xe2\x02\x14Hello\\V1\\GPBMetadata\xea\x02\tHello::V1b\x06proto3"
...
var file_hello_v1_hello_proto_depIdxs = []int32{
	...
	0, // 1: hello.v1.GreeterService.SayHelloStream:input_type -> hello.v1.SayHelloRequest
	1, // 2: hello.v1.GreeterService.SayHello:output_type -> hello.v1.SayHelloResponse
	1, // 3: hello.v1.GreeterService.SayHelloStream:output_type -> hello.v1.SayHelloResponse
